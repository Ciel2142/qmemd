...
/** Moved to src/stats.ts (qmemd hook stats reuses it); re-exported here so this bench module
 *  and its golden test keep importing it from the same place. */
export { wilson } from "../../src/stats.js";
